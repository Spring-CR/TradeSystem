...
// 实现FIX撤单指令
func (c *StarsFutChannel) doOrderCancelRequestByStars(cancelAction *schema.TradeActionLatestResp, order *schema.TradeOrder) (de *domain_error.Error) {
