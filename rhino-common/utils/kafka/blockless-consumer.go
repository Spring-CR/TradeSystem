...
func NewBlocklessConsumer(consumeTopic string, brokers []string, consumeBuffer int, consumeOffset int64, onDataReceived func(data []byte)) (*BlocklessConsumer, error) {
	inst := &BlocklessConsumer{
...
func (c *BlocklessConsumer) resetConsumer() error {
/*
	// 配置 Kafka 生产者
...
*/
	...
	log.Println("ConsumePartition from the newest offset...")
	c.consumer = partitionConsumer

	return nil
}

func (c *BlocklessConsumer) Start() {
