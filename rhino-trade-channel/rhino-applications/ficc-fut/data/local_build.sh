...
PLUG_VERSION=1.0.0.6   # 插件版本
IS_PROD=0              # 1 表示 true，即生产环境；0 表示 false，即测试环境

COMPONENT=data-ficc-fut
...
source ~/.bashrc
cd /usr/local/gopath/src/rhino-applications/ficc-fut/data
...
scp eagle@10.51.136.23:/usr/local/gopath/src/rhino-applications/ficc-fut/data/artifacts/x86/data ./docker/$COMPONENT
...
scp eagle@10.51.136.23:/usr/local/gopath/src/rhino-applications/ficc-fut/data/artifacts/arm/data ./docker/$COMPONENT
