...
PLUG_VERSION=1.0.3.8   # 插件版本
IS_PROD=0              # 1 表示 true，即生产环境；0 表示 false，即测试环境

COMPONENT=order-report-ficc-fut
...
source ~/.bashrc
cd /usr/local/gopath/src/rhino-applications/ficc-fut/order-report
...
scp eagle@10.51.136.23:/usr/local/gopath/src/rhino-applications/ficc-fut/order-report/artifacts/x86/order-report ./docker/$COMPONENT
...
scp eagle@10.51.136.23:/usr/local/gopath/src/rhino-applications/ficc-fut/order-report/artifacts/arm/order-report ./docker/$COMPONENT
