...
func NewOrderLeftQtyManager(tradeSide string, qtyFactor float64) *OrderLeftQtyManager {
	return &OrderLeftQtyManager{tradeSide: tradeSide, qtyFactor: qtyFactor, qtyMap: map[string]OrderLeftQty{}}
}
...
func (m *OrderLeftQtyManager) GetQtyFactor() float64 {
	return m.qtyFactor
}
